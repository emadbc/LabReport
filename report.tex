...
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{LIN.png}
\includegraphics[scale=0.3]{PUC.png}
\includegraphics[scale=0.3]{TSPFST.png}
\includegraphics[scale=0.3]{WRP.png}
\includegraphics[scale=0.3]{R100KEFST.png}

\caption{Running time in microsecond for each step of algorithm }
\end{figure}
